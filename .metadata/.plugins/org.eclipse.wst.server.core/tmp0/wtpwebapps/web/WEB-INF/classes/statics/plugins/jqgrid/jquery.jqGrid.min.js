...
c=[];$("option",e).each(function(){$(this).is(":selected") && c.push(parseInt(this.value,10));$(this).is(":selected")?k.jqGrid("showCol",n[this.value].name):k.jqGrid("hideCol",n[this.value].name)}),$("option[selected]",e).each(function(){/*c.push(parseInt(this.value,10))*/}),$.each(c,function(){delete
