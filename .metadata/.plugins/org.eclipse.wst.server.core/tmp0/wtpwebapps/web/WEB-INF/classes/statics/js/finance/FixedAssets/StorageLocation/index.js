    ...
    methods: {
        ...
        clickEvent (event, treeId, treeNode) {
           ...
           /* let selnode = _vm.$ztree.getSelectedNodes();
            ...
            $.ajax({
                type: 'post',
                url: contextPath+"/falocation/info",
        ...
        saveFun(){
            ...
            $.ajax({
                type: 'post',
                url: contextPath+"/falocation/saveOrUpdate",
        ...
        delFun() {
            ...
            if(_vm.selected == null || _vm.selected == ''){
                _vm.$Message.error('请选择要删除的存放地点')
                return;
            }
            $.ajax({
                type: 'post',
                url: contextPath+"/falocation/delete",
                data: {'id':_vm.selected},
                success: function (ret) {
                    console.log(ret)
                    if (ret.code == '100100') {
