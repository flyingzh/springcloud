    ...
    methods: {
        ...
        jqGridInit(){
            ...
            let config = Object.assign(this.base_config,this.data_config,{
                ...
                postData: this.data_config.requestData ? this.data_config.requestData : this.$parent.body,
                url :this.data_config.url || './../JSONData.json',
                pager: This.pager_id,
                jsonReader:this.data_config.jsonReader ? this.data_config.jsonReader : this.base_config.jsonReader,
                prmNames: {
                    page: "page",
                    rows: "limit",
                    order: "order",
